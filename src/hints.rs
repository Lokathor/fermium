...
pub const SDL_HINT_FRAMEBUFFER_ACCELERATION: &[u8] = c_str!("SDL_FRAMEBUFFER_ACCELERATION");
...
pub const SDL_HINT_RENDER_OPENGL_SHADERS: &[u8] = c_str!("SDL_HINT_RENDER_OPENGL_SHADERS");
...
pub const SDL_HINT_RENDER_DIRECT3D_THREADSAFE: &[u8] = c_str!("SDL_RENDER_DIRECT3D_THREADSAFE");
...
pub const SDL_HINT_RENDER_DIRECT3D11_DEBUG: &[u8] = c_str!("SDL_RENDER_DIRECT3D11_DEBUG");
...
pub const SDL_HINT_RENDER_SCALE_QUALITY: &[u8] = c_str!("SDL_RENDER_SCALE_QUALITY");
...
pub const SDL_HINT_VIDEO_ALLOW_SCREENSAVER: &[u8] = c_str!("SDL_VIDEO_ALLOW_SCREENSAVER");
...
pub const SDL_HINT_VIDEO_EXTERNAL_CONTEXT: &[u8] = c_str!("SDL_VIDEO_EXTERNAL_CONTEXT");
...
pub const SDL_HINT_VIDEO_X11_WINDOW_VISUALID: &[u8] = c_str!("SDL_VIDEO_X11_WINDOW_VISUALID");
...
pub const SDL_HINT_VIDEO_X11_NET_WM_PING: &[u8] = c_str!("SDL_VIDEO_X11_NET_WM_PING");
...
pub const SDL_HINT_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR: &[u8] = c_str!("SDL_VIDEO_X11_NET_WM_BYPASS_COMPOSITOR");
...
pub const SDL_HINT_VIDEO_X11_FORCE_EGL: &[u8] = c_str!("SDL_VIDEO_X11_FORCE_EGL");
...
/// is hidden
pub const SDL_HINT_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN: &[u8] = c_str!("SDL_WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN");

/// A variable to specify custom icon resource id from RC file on Windows
/// platform
pub const SDL_HINT_WINDOWS_INTRESOURCE_ICON: &[u8] = c_str!("SDL_WINDOWS_INTRESOURCE_ICON");

/// A variable to specify custom icon resource id from RC file on Windows
/// platform (small version)
pub const SDL_HINT_WINDOWS_INTRESOURCE_ICON_SMALL: &[u8] = c_str!("SDL_WINDOWS_INTRESOURCE_ICON_SMALL");
...
pub const SDL_HINT_WINDOWS_ENABLE_MESSAGELOOP: &[u8] = c_str!("SDL_WINDOWS_ENABLE_MESSAGELOOP");
...
pub const SDL_HINT_MOUSE_DOUBLE_CLICK_TIME: &[u8] = c_str!("SDL_MOUSE_DOUBLE_CLICK_TIME");

/// A variable setting the double click radius, in pixels.
pub const SDL_HINT_MOUSE_DOUBLE_CLICK_RADIUS: &[u8] = c_str!("SDL_MOUSE_DOUBLE_CLICK_RADIUS");

/// A variable setting the speed scale for mouse motion, in floating point,
/// when the mouse is not in relative mode
pub const SDL_HINT_MOUSE_NORMAL_SPEED_SCALE: &[u8] = c_str!("SDL_MOUSE_NORMAL_SPEED_SCALE");

/// A variable setting the scale for mouse motion, in floating point, when the
/// mouse is in relative mode
pub const SDL_HINT_MOUSE_RELATIVE_SPEED_SCALE: &[u8] = c_str!("SDL_MOUSE_RELATIVE_SPEED_SCALE");
...
pub const SDL_HINT_MOUSE_RELATIVE_MODE_WARP: &[u8] = c_str!("SDL_MOUSE_RELATIVE_MODE_WARP");
...
pub const SDL_HINT_MOUSE_FOCUS_CLICKTHROUGH: &[u8] = c_str!("SDL_MOUSE_FOCUS_CLICKTHROUGH");
...
/// Defaults to true.
pub const SDL_HINT_VIDEO_MINIMIZE_ON_FOCUS_LOSS: &[u8] = c_str!("SDL_VIDEO_MINIMIZE_ON_FOCUS_LOSS");
...
pub const SDL_HINT_IDLE_TIMER_DISABLED: &[u8] = c_str!("SDL_IOS_IDLE_TIMER_DISABLED");
...
pub const SDL_HINT_APPLE_TV_CONTROLLER_UI_EVENTS: &[u8] = c_str!("SDL_APPLE_TV_CONTROLLER_UI_EVENTS");
...
pub const SDL_HINT_APPLE_TV_REMOTE_ALLOW_ROTATION: &[u8] = c_str!("SDL_APPLE_TV_REMOTE_ALLOW_ROTATION");
...
///   applications)
pub const SDL_HINT_IOS_HIDE_HOME_INDICATOR: &[u8] = c_str!("SDL_IOS_HIDE_HOME_INDICATOR");
...
pub const SDL_HINT_ACCELEROMETER_AS_JOYSTICK: &[u8] = c_str!("SDL_ACCELEROMETER_AS_JOYSTICK");
...
pub const SDL_HINT_TV_REMOTE_AS_JOYSTICK: &[u8] = c_str!("SDL_TV_REMOTE_AS_JOYSTICK");
...
pub const SDL_HINT_XINPUT_USE_OLD_JOYSTICK_MAPPING: &[u8] = c_str!("SDL_XINPUT_USE_OLD_JOYSTICK_MAPPING");
...
pub const SDL_HINT_GAMECONTROLLERCONFIG: &[u8] = c_str!("SDL_GAMECONTROLLERCONFIG");
...
/// after the system is initialized with [`SDL_GameControllerMappingForGUID`]
/// and [`SDL_GameControllerAddMapping`]
pub const SDL_HINT_GAMECONTROLLERCONFIG_FILE: &[u8] = c_str!("SDL_GAMECONTROLLERCONFIG_FILE");
...
pub const SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES: &[u8] = c_str!("SDL_GAMECONTROLLER_IGNORE_DEVICES");
...
/// The variable can also take the form of @file, in which case the named file
/// will be loaded and interpreted as the value of the variable.
pub const SDL_HINT_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT: &[u8] = c_str!("SDL_GAMECONTROLLER_IGNORE_DEVICES_EXCEPT");
...
pub const SDL_HINT_GAMECONTROLLER_USE_BUTTON_LABELS: &[u8] = c_str!("SDL_GAMECONTROLLER_USE_BUTTON_LABELS");
...
pub const SDL_HINT_JOYSTICK_ALLOW_BACKGROUND_EVENTS: &[u8] = c_str!("SDL_JOYSTICK_ALLOW_BACKGROUND_EVENTS");
...
pub const SDL_HINT_JOYSTICK_HIDAPI_PS4: &[u8] = c_str!("SDL_JOYSTICK_HIDAPI_PS4");
...
pub const SDL_HINT_JOYSTICK_HIDAPI_PS4_RUMBLE: &[u8] = c_str!("SDL_JOYSTICK_HIDAPI_PS4_RUMBLE");
...
///
/// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const SDL_HINT_JOYSTICK_HIDAPI_STEAM: &[u8] = c_str!("SDL_JOYSTICK_HIDAPI_STEAM");
...
///
/// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const SDL_HINT_JOYSTICK_HIDAPI_SWITCH: &[u8] = c_str!("SDL_JOYSTICK_HIDAPI_SWITCH");
...
///
/// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const SDL_HINT_JOYSTICK_HIDAPI_XBOX: &[u8] = c_str!("SDL_JOYSTICK_HIDAPI_XBOX");
...
///
/// The default is the value of SDL_HINT_JOYSTICK_HIDAPI
pub const SDL_HINT_JOYSTICK_HIDAPI_GAMECUBE: &[u8] = c_str!("SDL_JOYSTICK_HIDAPI_GAMECUBE");
...
/// joystick subsystem.
pub const SDL_HINT_ENABLE_STEAM_CONTROLLERS: &[u8] = c_str!("SDL_ENABLE_STEAM_CONTROLLERS");
...
/// * "inverted-portrait"
/// * "inverted-landscape"
pub const SDL_HINT_QTWAYLAND_CONTENT_ORIENTATION: &[u8] = c_str!("SDL_QTWAYLAND_CONTENT_ORIENTATION");
...
/// * "StaysOnTop"
/// * "BypassWindowManager"
pub const SDL_HINT_QTWAYLAND_WINDOW_FLAGS: &[u8] = c_str!("SDL_QTWAYLAND_WINDOW_FLAGS");
...
pub const SDL_HINT_VIDEO_HIGHDPI_DISABLED: &[u8] = c_str!("SDL_VIDEO_HIGHDPI_DISABLED");
...
/// event when on Mac.
pub const SDL_HINT_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK: &[u8] = c_str!("SDL_MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK");
...
pub const SDL_HINT_VIDEO_WIN_D3DCOMPILER: &[u8] = c_str!("SDL_VIDEO_WIN_D3DCOMPILER");
...
pub const SDL_HINT_VIDEO_WINDOW_SHARE_PIXEL_FORMAT: &[u8] = c_str!("SDL_VIDEO_WINDOW_SHARE_PIXEL_FORMAT");
...
/// other, in-app means.
pub const SDL_HINT_WINRT_PRIVACY_POLICY_URL: &[u8] = c_str!("SDL_WINRT_PRIVACY_POLICY_URL");
...
pub const SDL_HINT_WINRT_PRIVACY_POLICY_LABEL: &[u8] = c_str!("SDL_WINRT_PRIVACY_POLICY_LABEL");
...
pub const SDL_HINT_WINRT_HANDLE_BACK_BUTTON: &[u8] = c_str!("SDL_WINRT_HANDLE_BACK_BUTTON");
...
/// windows are created.
pub const SDL_HINT_VIDEO_MAC_FULLSCREEN_SPACES: &[u8] = c_str!("SDL_VIDEO_MAC_FULLSCREEN_SPACES");
...
/// searched.
pub const SDL_HINT_ANDROID_APK_EXPANSION_MAIN_FILE_VERSION: &[u8] = c_str!("SDL_ANDROID_APK_EXPANSION_MAIN_FILE_VERSION");
...
/// By default this hint is not set and the APK expansion files are not
/// searched.
pub const SDL_HINT_ANDROID_APK_EXPANSION_PATCH_FILE_VERSION: &[u8] = c_str!("SDL_ANDROID_APK_EXPANSION_PATCH_FILE_VERSION");
...
pub const SDL_HINT_IME_INTERNAL_EDITING: &[u8] = c_str!("SDL_IME_INTERNAL_EDITING");
...
pub const SDL_HINT_ANDROID_TRAP_BACK_BUTTON: &[u8] = c_str!("SDL_ANDROID_TRAP_BACK_BUTTON");
...
pub const SDL_HINT_ANDROID_BLOCK_ON_PAUSE: &[u8] = c_str!("SDL_ANDROID_BLOCK_ON_PAUSE");
...
///
/// The value of this hint is used at runtime, so it can be changed at any time.
pub const SDL_HINT_RETURN_KEY_HIDES_IME: &[u8] = c_str!("SDL_RETURN_KEY_HIDES_IME");
...
/// with that ID.
pub const SDL_HINT_EMSCRIPTEN_KEYBOARD_ELEMENT: &[u8] = c_str!("SDL_EMSCRIPTEN_KEYBOARD_ELEMENT");
...
pub const SDL_HINT_WINDOWS_NO_CLOSE_ON_ALT_F4: &[u8] = c_str!("SDL_WINDOWS_NO_CLOSE_ON_ALT_F4");
...
pub const SDL_HINT_BMP_SAVE_LEGACY_FORMAT: &[u8] = c_str!("SDL_BMP_SAVE_LEGACY_FORMAT");
...
///   Visual Studio.
pub const SDL_HINT_WINDOWS_DISABLE_THREAD_NAMING: &[u8] = c_str!("SDL_WINDOWS_DISABLE_THREAD_NAMING");
...
pub const SDL_HINT_VIDEO_DOUBLE_BUFFER: &[u8] = c_str!("SDL_VIDEO_DOUBLE_BUFFER");
...
pub const SDL_HINT_AUDIO_RESAMPLING_MODE: &[u8] = c_str!("SDL_AUDIO_RESAMPLING_MODE");
...
pub const SDL_HINT_WAVE_RIFF_CHUNK_SIZE: &[u8] = c_str!("SDL_WAVE_RIFF_CHUNK_SIZE");
...
pub const SDL_HINT_DISPLAY_USABLE_BOUNDS: &[u8] = c_str!("SDL_DISPLAY_USABLE_BOUNDS");
...
extern "C" {
  ...
  pub fn SDL_AddHintCallback(name: *const c_char, callback: SDL_HintCallback, userdata: *mut c_void);
  ...
  pub fn SDL_DelHintCallback(name: *const c_char, callback: SDL_HintCallback, userdata: *mut c_void);
